...
{
    /// <inheritdoc />
    public partial class AddOrderAndLeftJoinToChallengeCardView : Migration
    {
        /// <inheritdoc />
...
GROUP BY 
  c.id, c.title, c.short_description, c.banner_image_path, c.challenge_visibility, c.organization_id, o.name;"
            );
        }
    }
}
